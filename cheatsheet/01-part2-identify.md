...
Seven stops, in route order. Ports: S01 8080 (`java -jar`), S02 8080
(Payara container), S03 8081, S04 8082, S05 8083. Every `run.sh` has a
matching `stop.sh`, and `run.sh` refuses to start if the port is busy.
